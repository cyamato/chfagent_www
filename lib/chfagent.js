    ...
    return new Promise((resolve, reject) => {
        console.log('Start');
                ...
                chfagent.on('exit', (code) => {
                    console.log(`start child process exited with code ${code}`);
                    resolve({
		        success: true,
...
function stop () {
    return new Promise((resolve, reject) => {
        ...
        console.log('stop spawned')
 	chfagent.on('exit', (code) => {
            console.log(`stop child process exited with code ${code}`);
            resolve({
               success: true,
	...
	console.log('stop on error function');
        chfagent.on('error', (err) => {
        ...
        console.log('stop function complted');
    });
}
