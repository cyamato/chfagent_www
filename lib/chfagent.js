...
function setConfig (chfagent_config) {
    return new Promise((resolve, reject) => {
        let content = "email=" + chfagent_config.email + '\n';
        content += "token=" + chfagent_config.token + '\n';
        content += "host=" + chfagent_config.host + '\n';
        content += "port=" + chfagent_config.port + '\n';
        console.log("setting config");
        console.log(chfagent_config);
        console.log(content);
        try {
...
function start () {
    return new Promise((resolve, reject) => {
        ...
        getConfig()
            .then((result) => {
                // const chfagent = spawn('chfagent', 
                //     [
                //         `-api_email=${result.email}`, 
                ...
                // const touch = spawn('touch', 
                //     [
                //         `/var/lock/subsys/chfagent`
                //     ], 
                //     {
                //         cwd: '/',
                //         detached: true,
                ...
                resolve({
                    success: true,
                    message: 'CHFAgent started'
                });
            })
            .catch((reson) => {
                let msg = reson.message || 'Error starting CHFAgent';
                console.log('error');
                reject({
                    success: false,
                    message: msg
...
function stop () {
    return new Promise((resolve, reject) => {
        ...
        //     }
        // );
        // if (rm.error || rm.output[2]) {
        //     let msg = rm.error || rm.output[2];
        //     console.log('error');
        //     console.log(msg);
        //     return;
        // } else {
        ...
        // }
        // rm.unref();
        if (chfagent.error || chfagent.output[2]) {
